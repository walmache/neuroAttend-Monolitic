document.addEventListener('DOMContentLoaded', function() {
    ...
    // if (window.sessionData.warning) {
    //     toastr.warning(window.sessionData.warning);
    // }

    // if (window.sessionData.info) {
    //     toastr.info(window.sessionData.info);
    // }

    // if (window.sessionData.errors.length > 0) {
    //     window.sessionData.errors.forEach(function(error) {
    //         toastr.error(error);
    //     });
    // }
